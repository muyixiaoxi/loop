...
import { Input, Dropdown, Menu, Modal, Form, Button, message, Checkbox } from "antd";
              ...
              {friendsList.map((friend) => (
                <div key={friend.id}>
                  <Checkbox value={friend.id} >
                    ...
                    <div> <img src={friend.avatar} alt={friend.name} style={{ width: 24, height: 24, borderRadius: '50%' }} /></div>
                    <div style={{marginLeft:'10px'}}>{friend.nickname}</div>
                    </div>
                  </Checkbox>
                </div>
              ))}
