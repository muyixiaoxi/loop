...
type GroupMessage struct {
	...
	Type        int    `gorm:"comment:消息类型:0-文字，1-图片，2-文件，3-语音，4-视频,5-系统消息;type:tinyint;not null"` // 消息类型:0-文字，1-图片，2-文件，3-语音，4-视频
	ReceiverIds string `gorm:"comment:接收者id;type:varchar(64);not null"`
